...
a persistence unit "pretest4PersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "pretest4/pom.xml":
...
artifacts ("pretest4-ejb.jar" and "pretest4-web.war") are already built. You can build
